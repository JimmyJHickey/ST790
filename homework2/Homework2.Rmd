...
With the backtracking we see a few inconsitent points at the beginning. This is where the algorithm is adjusting its step size. After that we see similar, consistent trends as in the fixed case. Notice that these each seem to converge in fewer iterations than for the fixed case.
